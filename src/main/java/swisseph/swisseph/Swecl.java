...
class Swecl
  ...
  */
   ...
   */
  private int eclipse_where(double tjd_ut, int ipl, StringBuilder starname, int ifl,
                            double[] geopos, double[] dcore, StringBuilder serr) {
    int i;
    int retc = 0, niter = 0;
...
//      goto iter_where;
  ...
  private int calc_planet_star(double tjd_et, int ipl, StringBuilder starname, int iflag, double[] x, StringBuilder serr) {
    int i;
 ...
 *         declare as attr[20] at least !<BR>
  ...
  */
  ...
  private int eclipse_how(double tjd_ut, int ipl, StringBuilder starname,
...
//end_search_global:
  ...
  */
   ...
   */
  int swe_lun_occult_when_loc(double tjd_start, int ipl, StringBuilder starname, int ifl,
...
//        goto next_try;
  ...
  private int occult_when_loc(double tjd_start, int ipl, StringBuilder starname,
      int ifl, double[] geopos, double[] tret, double[] attr,
      int backward, StringBuilder serr) {
    int i, j, k, m;
    int retflag = 0;
    double t, tjd, dt;
    DblObj dtint=new DblObj();
...
//        goto next_lun_ecl;
  ...
  * See <A HREF="Swecl.html#swe_pheno_ut(double, int, int, double[], java.lang.StringBuilder)">swe_pheno_ut(...)</A> for missing information.
  */
  ...
  * @see swisseph.DblObj
  */
  int swe_rise_trans(double tjd_ut, int ipl, StringBuilder starname,
                     int epheflag, int rsmi, double[] geopos,
                     double atpress, double attemp,
                     DblObj tret, StringBuilder serr) {
  ...
  private int calc_mer_trans(double tjd_ut, int ipl, int epheflag, int rsmi,
                             double[] geopos, StringBuilder starname,
                             DblObj tret, StringBuilder serr) {
    int i;
    double tjd_et = tjd_ut + SweDate.getDeltaT(tjd_ut);
  ...
  * <CODE>tjd_et&nbsp;+&nbsp;SweDate.getDeltaT(tjd_et)</CODE>.<P>
  * See <A HREF="Swecl.html#swe_nod_aps_ut(double, int, int, int, double[], double[], double[], double[], java.lang.StringBuilder)">swe_nod_aps_ut(...)</A> for missing information.
  */
...
//      sm.swi_mean_lunar_elements(tjd_et, &xna[0], &xna[3], &xpe[0], &xpe[3]);
  ...
  * something fails. 
  * @return SweConst.OK (0) or SweConst.ERR (-1)
  * @see Swecl.html#swe_nod_aps(double, int, int, int, double[], double[], double[], double[], java.lang.StringBuilder)
  * @see swisseph.SweConst#OK
  * @see swisseph.SweConst#ERR
