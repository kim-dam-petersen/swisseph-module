...
//                                          // Identical in most ISO-8859 sets
	...
	/**
	 * The character to be used as the minute of arc character (&#x2032;). Only textmode applications
	 * (and probably awt applications in Java 1.1 and below?) will require to
	 * differentiate between different characters, awt&nbsp;/ swing components of
	 * Java 1.2 and above will use the unicode encoding always!
	 */
	public String OMINUTE_STRING = "′"; /* degree as string, utf8 encoding */
	/**
	 * The character to be used as the second of arc character (&#x2033;). Only textmode applications
	 * (and probably awt applications in Java 1.1 and below?) will require to
	 * differentiate between different characters, awt&nbsp;/ swing components of
	 * Java 1.2 and above will use the unicode encoding always!
	 */
	public String OSECOND_STRING = "″"; /* degree as string, utf8 encoding */
