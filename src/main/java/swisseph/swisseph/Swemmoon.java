 ...
 */
  ...
  private double mean_node_corr[] = new double[]{
  -2.56,
   ...
   * in 100-year steps. corrections are set to 0 between the years 0 and 3000 */
  private double mean_apsis_corr[] = new double[]{
  7.525,
  ...
  static final double CORR_MNODE_JD_T0GREG = -3063616.5;   /* 1 jan -13100 greg. */
  ...
  static final double CORR_MNODE_JD_T3GREG =  7930182.5;   /* 1 jan  17000 greg. */
   ...
   */
  int swi_mean_node(double J, double pol[], StringBuilder serr) {
    return swi_mean_node(J, pol, 0, serr);
  }
  int swi_mean_node(double J, double pol[], int offs, StringBuilder serr) {
    String s;
    double dcor;
    T = (J-SwephData.J2000)/36525.0;
    T2 = T*T;
  ...
  static final double CORR_MAPOG_JD_T0GREG = -3063616.5;   /* 1 jan -13100 greg. */
  static final double CORR_MAPOG_JD_T1GREG = 1209720.5;   /* 1 jan  -1400 greg. */
  static final double CORR_MAPOG_JD_T2GREG = 2780263.5;   /* 1 jan   2900 greg. */
  static final double CORR_MAPOG_JD_T3GREG = 7930182.5;   /* 1 jan  17000 greg. */
   ...
   */
  int swi_mean_apog(double J, double pol[], StringBuilder serr) {
    return swi_mean_apog(J, pol, 0, serr);
  }
  int swi_mean_apog(double J, double pol[], int offs, StringBuilder serr) {
    double node, dcor;
    String s;
    T = (J-SwephData.J2000)/36525.0;
    T2 = T*T;
